...
-- POV-Ray colors
M.pov_aquamarine = "#70db93"
M.pov_brown = "#a52a2a"
M.pov_coral = "#ff7f50"
M.pov_forestgreen = "#238e23"
M.pov_gold = "#cd7f32"
M.pov_maroon = "#b03060"
M.pov_orange = "#ffa500"
M.pov_pink = "#ffc0cb"
...
M = {
    ...
    LimeGreen = "#32CC32",
    Maroon = "#8E236B",
    MediumAquamarine = "#32CC99",
    MediumBlue = "#3232CC",
    MediumForestGreen = "#6B8E23",
    MediumGoldenrod = "#EAEABD",
    MediumOrchid = "#9370DB",
    ...
    VeryDarkBrown = "#592924",
    DarkBrown = "#5C4033",
    DarkTan = "#96694F",
    GreenCopper = "#527D75",
    DkGreenCopper = "#4A756E",
    DustyRose = "#856363",
    HuntersGreen = "#215E4F",
    Scarlet = "#8C1717",
    Med_Purple = "#BA29F5",
