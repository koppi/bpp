...
if (car_model==1) then -- Citroen GS (JVP)
  ...
  chassis_sdl="object{citroen_gs"
  right_tire_sdl="object{gs_tyre"
  left_tire_sdl="object{gs_tyre rotate 180*y"
elseif (car_model==2) then -- Nissan Micra (by Ren Bui)
...
front_right_spindle.pre_sdl = "object{spindle"
...
front_left_spindle.pre_sdl = "object{spindle"
...
rear_right_spindle.pre_sdl = "object{spindle"
...
rear_left_spindle.pre_sdl = "object{spindle"
...
front_right_upper_arm.pre_sdl = "object{control_arm"
...
front_right_lower_arm.pre_sdl = "object{control_arm"
...
front_left_upper_arm.pre_sdl = "object{control_arm"
...
front_left_lower_arm.pre_sdl = "object{control_arm"
...
rear_right_upper_arm.pre_sdl = "object{control_arm"
...
rear_right_lower_arm.pre_sdl = "object{control_arm"
...
rear_left_upper_arm.pre_sdl = "object{control_arm"
...
rear_left_lower_arm.pre_sdl = "object{control_arm"
...
front_right_wheel_disc_constraint = btHingeConstraint(
  front_right_disc.body,
  front_right_wheel.body,
...
front_left_wheel_disc_constraint = btHingeConstraint(
  front_left_disc.body,
  front_left_wheel.body,
  pivotA, pivotB, axisA, axisB
)
...
v.pre_sdl="#declare chassis_pos=<"
  ..chassis.pos.x..","
  ..chassis.pos.y..","
  ..chassis.pos.z..">;"
  .."\n"
  .."#declare front_pos=<"
  ..front_stabilizer_bar.pos.x..","
  ..front_stabilizer_bar.pos.y..","
  ..front_stabilizer_bar.pos.z..">;"
  .."\n"..
  "#declare rear_pos=<"
  ..rear_stabilizer_bar.pos.x..","
  ..rear_stabilizer_bar.pos.y..","
  ..rear_stabilizer_bar.pos.z..">;"
  .."\n".."\n"..pre_sdl
